                ...
                <tr>
                    ...
                    <td>
                        @if($data->status=='active')
                            <span class="badgecstm {{$data->status}}">{{$data->status}}</span>
                        @else
                            <span class="badgecstm {{$data->status}}">{{$data->status}}</span>
                        @endif
                    </td>
                    <td>
                        <div class="action-btns">
                            <a href="{{route('post-category.edit',$data->id)}}" class="btn btn-icon" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                            <form method="POST" action="{{route('post-category.destroy',[$data->id])}}">
                                @csrf
                                @method('delete')
                                <button class="btn btn-icon" data-id="{{$data->id}}" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></button>
                            </form>
                        </div>
                    </td>
                    {{-- Delete Modal --}}
