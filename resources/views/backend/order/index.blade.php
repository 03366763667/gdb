          ...
          <tbody>
            ...
            @endphp
                <tr>
                    ...
                    <td>
                        <div class="action-btns orderActions">
                            <a href="{{route('order.show',$order->id)}}" class="btn btn-icon" data-toggle="tooltip" title="view" data-placement="bottom"><i class="fas fa-eye"></i></a>
